...
enum RequestStatus implements BaseWebSocketCode {
  ...
  String get message => const {
    ...
    RequestStatus.UnsupportedRequestBatchExecutionType:
        'The request batch execution type is not supported.',
    RequestStatus.MissingRequestField: 'A required request field is missing.',
    RequestStatus.MissingRequestData:
        'The request does not have a valid requestData object.',
    RequestStatus.InvalidRequestField: 'Generic invalid request field message.',
    ...
    RequestStatus.OutputRunning:
        'An output is running and cannot be in order to perform the request.',
    RequestStatus.OutputNotRunning: 'An output is not running and should be.',
    ...
    RequestStatus.OutputDisabled: 'An output is disabled and should not be.',
    ...
    RequestStatus.InvalidResourceType: 'The type of resource found is invalid.',
